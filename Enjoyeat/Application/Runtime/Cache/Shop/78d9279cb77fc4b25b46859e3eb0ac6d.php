...
<link href="/dev/XDLProject/Enjoyeat/Public/Shop/ready/app_002.css" rel="stylesheet">
<link href="/dev/XDLProject/Enjoyeat/Public/Shop/ready/app.css" rel="stylesheet">
</head>
...
<div class="ng-scope" ng-include="'modules/records/header.html'">
	...
	<div>
		<a href="https://kaidian.ele.me/" ui-sref="home" style="text-decoration: none"><img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/73caa017b45adf0004bcb332f168d264.svg" alt="LOGO">
		<span class="ml-10">商户中心</span></a>
		<div class="pull-right ng-binding">
			<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/25bf9c3b73ffd2e9c3b986898f026fa9.svg"> 123412342343 <img class="arrow" src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/020803b31ca45a097708c0cebcf12571.svg">
...
<div class="ng-scope ng-isolate-scope" id="guide" ga-point="{title:'过渡页'}">
	...
	<div class="guide-wrap clearfix">
		<div class="guide-box">
			<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/guide_store.png" alt="门头照">
			<hr>
			<dl>
		...
		<div class="guide-box">
			<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/guide_inner.png" alt="店内照">
			<hr>
			<dl>
		...
		<div class="guide-box margin-right-0">
			<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/guide_identity.png" alt="身份证照">
			<hr>
			<dl>
		...
		<div class="guide-box">
			<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/guide_business_license.png" alt="营业执照">
			<hr>
			<dl>
		...
		<div class="guide-box">
			<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/guide_service_license.png" alt="服务许可证">
			<hr>
			<dl>
	...
	<div class="footer">
		<div class="box margin-0 clearfix">
			<div class="other-copyright">
				<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/586b06784b835e1264be08c9a278a45b.svg" alt="">
			...
			<div class="about">
				<div class="row">
					...
					<div class="about-info">
						<h5>其他</h5>
						<ul class="list-unstyled">
							<li><a href="https://kaidian.ele.me/process.pdf" target="_blank" class="download"> 餐厅办证流程 <img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/ae3716b6694c3f6effbee4997b6038da.svg" alt="下载"></a></li>
							<li><a href="https://kaidian.ele.me/standard.pdf" target="_blank" class="download"> 餐厅经验卫生标准 <img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/ae3716b6694c3f6effbee4997b6038da.svg" alt="下载"></a></li>
						</ul>
					</div>
					<div class="footer-info">
						<ul class="list-unstyled">
							...
							<div href="javascript:;" class="icon-wechat">
								<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/c681b66b64bec947d63fb0417b9bc3e5.svg" alt="微信">
								<div class="dropbox dropbox-bottom footer-contect-dropbox">
									<img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/wexinqc1002x.png" alt="微信号: elemeorder">
									<p>
										微信号: elemeorder
									</p>
									<p>
							...
							<a href="http://e.weibo.com/elemeorder" target="_blank"><img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/3a2cbc5d1431408e74e9248187469d1d.svg" alt=""></a>
							<a href="http://page.renren.com/elemeorder" target="_blank"><img src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/12a0c873b21534dd22771d047116000f.svg" alt=""></a></span></li>
						</ul>
					</div>
				</div>
			</div>
...
<script src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/analytics.js" async=""></script>
<script src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/nevermore.js"></script>
<script src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/ga.js"></script>
<script type="text/javascript" src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/vendor.js"></script>
<script type="text/javascript" src="/dev/XDLProject/Enjoyeat/Public/Shop/ready/app.js"></script>
</body>
</html>