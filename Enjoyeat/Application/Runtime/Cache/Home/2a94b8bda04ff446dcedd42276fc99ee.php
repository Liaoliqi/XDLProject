    ...
    <div ng-class="{mapmode: mapMode}" class="map ng-scope">
      <div class="container">
        <div class="map-header clearfix" map-header="">
          <h1><a ubt-click="1433" href="/"><img src="/git/Enjoyeat/Public/home/images/tips.png"></a></h1>
        ...
        <div ng-class="{mapmode: mapMode}" class="map-main ng-isolate-scope" map-mode="mapMode" map-main="">
          <h2 class="map-logo"><img src="/git/Enjoyeat/Public/home/images/logo.png"></h2>
        ...
        <div class="mapfooter" map-footer="">
          ...
          <div class="footer-police container">
            <a target="_blank" rel="nofollow" href="http://www.zx110.org/picp/?sn=310100103568"><img height="30" src="/git/Enjoyeat/Public/home/images/picp_bg.e373b3.jpg" alt="已通过沪公网备案，备案号 310100103568"></a>
          </div>
        </div>
        <div class="map-car">
        </div>
