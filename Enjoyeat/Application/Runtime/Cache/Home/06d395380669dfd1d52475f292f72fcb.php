...
<div ng-view="" role="main" class="ng-scope">
    <div class="profile profile-container container" profile-container="" page-name="profile" page-title="个人中心" page-title-visible="false">
       ...
       <div class="profile-panel" role="main" style="background:white">
           <!-- ngIf: pageTitleVisible -->
           <h3 ng-if="pageTitleVisible" class="profile-paneltitle ng-scope" style="margin-top:10px;" ><span ng-bind="pageTitle" class="ng-binding">个人资料</span> <span class="subtitle ng-binding" ng-bind-html="pageSubtitle | toTrusted"></span></h3>
           <!-- end ngIf: pageTitleVisible -->
           <div class="profile-panelcontent" ng-transclude="">
            <div class="profileinfo ng-scope">
             <p class="profileinfo-item"><span class="profileinfo-label">头像</span> <span class="profileinfo-face"><img ng-src="//static11.elemecdn.com/eleme/desktop/media/img/default-avatar.38e40d.png" alt="43216d0fb" src="./个人中心_个人资料 _ 饿了么网上订餐_files/default-avatar.38e40d.png" /> <a class="profileinfo-facedit" href="https://www.ele.me/profile/changeavatar">编辑头像</a></span></p>
             <p class="profileinfo-item"><span class="profileinfo-label">用户名</span> <span><span class="profileinfo-value ng-binding" ng-bind="user.username">43216d0fb</span> 
               <!-- ngIf: user.is_auto_generated.username --><a ng-if="user.is_auto_generated.username" class="profileinfo-link ng-scope" href="javascript:" dialog-trigger="username">[修改]</a>
               <!-- end ngIf: user.is_auto_generated.username --></span></p>
             <p class="profileinfo-item"><span class="profileinfo-label">手机号码</span> 
              <!-- ngIf: user.is_mobile_valid --><span ng-if="user.is_mobile_valid" class="ng-scope"><span class="profileinfo-value ng-binding" ng-bind="user.mobile">18020225275</span> <a class="profileinfo-link" href="https://www.ele.me/profile/security">[修改]</a></span>
