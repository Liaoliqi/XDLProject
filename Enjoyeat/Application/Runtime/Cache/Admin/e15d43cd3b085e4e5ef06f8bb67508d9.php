...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                  <thead>
                                   <tr>
                                     <?php if(is_array($th)): foreach($th as $key=>$v): ?><th><?php echo ($v); ?></th><?php endforeach; endif; ?>
                                   </tr>
                                 </thead>
                                 <tbody>
                                    <?php if(is_array($cont)): $i = 0; $__LIST__ = $cont;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                          <?php if(is_array($val)): $i = 0; $__LIST__ = $val;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><td><?php echo ($va); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
                                            <td>
                                                <a href="<?php echo U('Access/Control/id/'.$val['id']);?>" class="btn btn-info">修改</a>
                                            </td>
    ...
    <script src="/XDLProject/Enjoyeat/Public/Assets/plugins/nanoScroller/jquery.nanoscroller.min.js"></script>
    <script src="/XDLProject/Enjoyeat/Public/Assets/js/application.js"></script>
    <!--Page Leve JS -->
    <script src="/XDLProject/Enjoyeat/Public/Assets/plugins/dataTables/js/jquery.dataTables.js"></script>


    <script type="text/javascript" src="https://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="//cdn.datatables.net/1.10.12/css/jquery.dataTables.min.css"></script>
    <script src="/XDLProject/Enjoyeat/Public/Assets/plugins/dataTables/js/dataTables.bootstrap.js"></script>
    <script>
