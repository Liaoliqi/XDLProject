...
<body>
        ...
        <aside class="sidebarRight">
            <div id="rightside-navigation ">
                ...
                <div class="list-contacts">
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/dev/XDLProject/Enjoyeat/Public/Assets/img/avatar.gif" class="img-circle">
                        </div>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/dev/XDLProject/Enjoyeat/Public/Assets/img/avatar1.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Jeffrey Ashby</h4>
                            <p>New York, NY</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/dev/XDLProject/Enjoyeat/Public/Assets/img/avatar2.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>John Douey</h4>
                            <p>Dallas, TX</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/dev/XDLProject/Enjoyeat/Public/Assets/img/avatar3.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Ellen Baker</h4>
                            <p>London</p>
                ...
                <div class="list-contacts">
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/dev/XDLProject/Enjoyeat/Public/Assets/img/avatar4.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Ivan Bella</h4>
                            <p>Tokyo, Japan</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/dev/XDLProject/Enjoyeat/Public/Assets/img/avatar5.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Gerald Carr</h4>
                            <p>Seattle, WA</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/dev/XDLProject/Enjoyeat/Public/Assets/img/avatar6.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
    ...
    <script src="/dev/XDLProject/Enjoyeat/Public/Assets/plugins/nanoScroller/jquery.nanoscroller.min.js"></script>
    <script src="/dev/XDLProject/Enjoyeat/Public/Assets/js/application.js"></script>
    <!--Page Leve JS -->
    <script src="/dev/XDLProject/Enjoyeat/Public/Assets/plugins/dataTables/js/jquery.dataTables.js"></script>
    <script src="/dev/XDLProject/Enjoyeat/Public/Assets/plugins/dataTables/js/dataTables.bootstrap.js"></script>
    <script>
