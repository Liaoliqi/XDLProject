...
<head>
    ...
    <!-- Vector Map  -->
    <link rel="stylesheet" href="/git/Enjoyeat/Public/Assets/plugins/jvectormap/css/jquery-jvectormap-1.2.2.css">
    <!-- ToDos  -->
    <link rel="stylesheet" href="/git/Enjoyeat/Public/Assets/plugins/todo/css/todos.css">
    <!-- Morris  -->
    <link rel="stylesheet" href="/git/Enjoyeat/Public/Assets/plugins/morris/css/morris.css">
    <!-- Fonts -->
...
<body>
            ...
            <div class="user-nav">
                <ul>
                    <li class="dropdown messages">
                        ...
                        <ul class="dropdown-menu alert animated fadeInDown">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/git/Enjoyeat/Public/Assets/img/avatar.gif" alt="" class="img-circle">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/git/Enjoyeat/Public/Assets/img/avatar1.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/git/Enjoyeat/Public/Assets/img/avatar2.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/git/Enjoyeat/Public/Assets/img/avatar3.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/git/Enjoyeat/Public/Assets/img/avatar4.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                    ...
                    <li class="profile-photo">
                        <img src="/git/Enjoyeat/Public/Assets/img/avatar.png" alt="" class="img-circle">
                    </li>
        ...
        <aside class="sidebarRight">
            <div id="rightside-navigation ">
                ...
                <div class="list-contacts">
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/git/Enjoyeat/Public/Assets/img/avatar.gif" class="img-circle">
                        </div>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/git/Enjoyeat/Public/Assets/img/avatar1.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Jeffrey Ashby</h4>
                            <p>New York, NY</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/git/Enjoyeat/Public/Assets/img/avatar2.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>John Douey</h4>
                            <p>Dallas, TX</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/git/Enjoyeat/Public/Assets/img/avatar3.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Ellen Baker</h4>
                            <p>London</p>
                ...
                <div class="list-contacts">
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/git/Enjoyeat/Public/Assets/img/avatar4.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Ivan Bella</h4>
                            <p>Tokyo, Japan</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/git/Enjoyeat/Public/Assets/img/avatar5.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Gerald Carr</h4>
                            <p>Seattle, WA</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/git/Enjoyeat/Public/Assets/img/avatar6.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
    ...
    <!-- -- js block start ---->
        ...
        <!--Page Level JS-->
        <script src="/git/Enjoyeat/Public/Assets/plugins/countTo/jquery.countTo.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/weather/js/skycons.js"></script>
        <!-- FlotCharts  -->
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.resize.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.canvas.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.image.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.categories.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.crosshair.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.errorbars.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.fillbetween.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.navigate.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.pie.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.selection.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.stack.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.symbol.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.threshold.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.colorhelpers.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.time.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/jquery.flot.example.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/flot/js/Chart.bundle.js"></script>
        <!-- Morris  -->
        <script src="/git/Enjoyeat/Public/Assets/plugins/morris/js/morris.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/morris/js/raphael.2.1.0.min.js"></script>
        <!-- Vector Map  -->
        <script src="/git/Enjoyeat/Public/Assets/plugins/jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="/git/Enjoyeat/Public/Assets/plugins/jvectormap/js/jquery-jvectormap-world-mill-en.js"></script>
        <!-- ToDo List  -->
        <script src="/git/Enjoyeat/Public/Assets/plugins/todo/js/todos.js"></script>
