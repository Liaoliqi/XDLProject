...
<body>
    ...
    <!--实现搜索分页-->
    <script src="/git/Enjoyeat/Public/Assets/plugins/dataTables/js/jquery.dataTables.min.js"></script>

    <script src="/git/Enjoyeat/Public/Assets/plugins/dataTables/js/dataTables.bootstrap.js"></script> 
